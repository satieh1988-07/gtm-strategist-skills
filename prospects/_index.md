...
|---------|----------|-----------|---------------|-------|------|-----------------|-------------|
| [Color Street](color-street.md) | Nail/Cosmetics | 20K–30K | Custom commission engine + Shopify | Demo complete — blocked on Shopify integration | Yes (~70%) | May 1, 2026 | Cash & Carry DSO |
